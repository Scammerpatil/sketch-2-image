    ...
    <>
      <div className="navbar px-10 py-2 bg-base-300">
        <div className="navbar-start">
          ...
          >
            <IconPhotoScan size={56} className="text-secondary mx-2" />
            <div className="flex flex-col items-start gap-1 w-full">
              <div className="flex items-baseline gap-[2px]">
                <span className="text-primary font-extrabold text-xl">
                  Image
                </span>
                <span className="text-secondary font-extrabold text-xl">3</span>
                <span className="text-accent font-semibold text-xl">Diffy</span>
              </div>
              <hr className="w-full border border-base-content" />
              <span className="text-sm text-base-content/70 italic">
                Turn Your 2D Images into Stunning 3D Models
              </span>
            </div>
          </Link>
        </div>
